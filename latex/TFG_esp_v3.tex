...
\label{min:tr}
\begin{aligned}
	\min_{p} m_k(p) = f(x_k) + g^T_kp + \frac{1}{2}p^TB_kp \\
...
\begin{align}
	...
	\text{s.a.} \quad & \Vert p \Vert \leq \Delta_k,
\end{align}
Donde $\Delta_k>0$ es el radio de la región de confianza. Este método es considerado el primero en realizar un enfoque de región de confianza para un problema de optimización sin restricciones.
