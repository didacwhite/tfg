...
Finalmente, Moré presenta la siguiente versión del algoritmo de Levenberg-Marquardt.
...
\begin{steps}
	...
	\item Si $\rho_k \leq 1/4$, asignar $\Delta_{k+1} \in \left[
		\frac{1}{10}\Delta_k, \frac{1}{4}\Delta_k \right]$. \\
		Si $\rho_k \in \left[ 1/4, 3/4 \right]$ y $\lambda_k = 0$,
