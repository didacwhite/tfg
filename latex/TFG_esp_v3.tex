...
Por último, veamos una característica de los algoritmos, el tipo de convergencia es una medida
de efectividad de un algoritmo, es decir, la velocidad con la que llega a una solución. Sea
