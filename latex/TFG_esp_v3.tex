...
%Finalmente se implementa el algoritmo en Matlab\textsuperscript{®} para comprobar su funcionamiento y compararlo con la alternativa propia del programa \code{lsqnonlin}.
...
%----------------- CAMBIO DE PROBLEMA TEORICO A NUMÉRICO -----------%
...
\begin{theorem}
	...
	\begin{enumerate}
		...
		\item\label{item4}
		$\lambda_k \leq M < \infty, \, \forall k$, esto es,
