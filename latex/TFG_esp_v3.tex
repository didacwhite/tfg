...
\begin{split}
	m_k(p_k)\enspace
	=&\quad \frac{1}{2}r_k^Tr_k+r_k^TJ_ks_k+\frac{1}{2}s_k^TJ_k^TJ_ks_k \\
	=&\quad \frac{1}{2}r_k^Tr_k-s_k^T(J_k^TJ_k+\lambda_kI)s_k+
										\frac{1}{2}s_k^TJ_k^TJ_ks_k \\
	=&\quad \frac{1}{2}r_k^Tr_k-\lambda_ks_k^Ts_k-
										\frac{1}{2}s_k^TJ_k^TJ_ks_k.
\end{split}
\end{equation}
